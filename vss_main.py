...
be a numeric value, and not a standard time unit like seconds or miliseconds.
...
The simulator will print the results to a txt file called 'results' 
...
time_unit = input("Input the desired time unit:")
